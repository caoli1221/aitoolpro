document.addEventListener('DOMContentLoaded', async () => {
  const tools = [
    ...
    { id: 'mita-write', name: '秘塔写作猫', category: 'ai-writing', icon: '🐱', description: 'AI写作润色工具，中文纠错和改写', rating: 4.3, featured: false, url: 'https://xiezuocat.com' },
    { id: 'effidit', name: 'Effidit', category: 'ai-writing', icon: '✏️', description: '腾讯AI写作助手，多场景文案生成', rating: 4.2, featured: false, url: 'https://effidit.qq.com' },
    { id: 'huolongguo', name: '火龙果写作', category: 'ai-writing', icon: '🐉', description: 'AI智能写作与润色平台', rating: 4.1, featured: false, url: 'https://www.mypitaya.com' },
    { id: 'niji-journey', name: 'Niji Journey', category: 'ai-drawing', icon: '🌸', description: '二次元AI绘画，动漫风格最佳', rating: 4.5, featured: false, url: 'https://nijijourney.com' },
    { id: 'ideogram', name: 'Ideogram', category: 'ai-drawing', icon: '💡', description: 'AI图片生成，文字渲染最强', rating: 4.3, featured: false, url: 'https://ideogram.ai' },
    { id: 'firefly', name: 'Adobe Firefly', category: 'ai-drawing', icon: '🔥', description: 'Adobe AI创作套件，商业安全', rating: 4.4, featured: false, url: 'https://firefly.adobe.com' },
    { id: 'fooocus', name: 'Fooocus', category: 'ai-drawing', icon: '🎯', description: 'SD简化版，零门槛本地AI画图', rating: 4.2, featured: false, url: 'https://github.com/lllyasviel/Fooocus' },
    { id: 'tensor-art', name: 'Tensor.art', category: 'ai-drawing', icon: '🎨', description: '在线AI模型社区，免费SD出图', rating: 4.1, featured: false, url: 'https://tensor.art' },
    { id: 'd-id', name: 'D-ID', category: 'ai-video', icon: '🧑', description: 'AI数字人视频，照片秒变说话', rating: 4.4, featured: false, url: 'https://www.d-id.com' },
    { id: 'viggle', name: 'Viggle AI', category: 'ai-video', icon: '💃', description: 'AI角色动画，让任何人跳舞', rating: 4.2, featured: false, url: 'https://viggle.ai' },
    { id: 'hailuo-video', name: '海螺AI视频', category: 'ai-video', icon: '🌀', description: 'MiniMax视频生成，国产新秀', rating: 4.3, featured: false, url: 'https://hailuoai.video' },
    { id: 'genmo', name: 'Genmo', category: 'ai-video', icon: '🤖', description: 'AI视频生成，交互式创作', rating: 4.0, featured: false, url: 'https://genmo.ai' },
    { id: 'domoai', name: 'DomoAI', category: 'ai-video', icon: '🎨', description: 'AI视频风格转换，一键动漫化', rating: 4.3, featured: false, url: 'https://domoai.app' },
    { id: 'tme-studio', name: 'TME Studio', category: 'ai-audio', icon: '🎵', description: '腾讯音乐AI创作工具', rating: 4.0, featured: false, url: 'https://y.tencentmusic.com' },
    { id: 'voloco', name: 'Voloco', category: 'ai-audio', icon: '🎤', description: 'AI人声处理，手机端自动修音', rating: 4.1, featured: false, url: 'https://voloco.rove.com' },
    { id: 'you-com', name: 'You.com', category: 'ai-search', icon: '🔍', description: 'AI搜索引擎，多模式搜索', rating: 4.2, featured: false, url: 'https://you.com' },
    { id: 'andi-search', name: 'Andi', category: 'ai-search', icon: '🤖', description: '对话式AI搜索引擎', rating: 4.0, featured: false, url: 'https://andisearch.com' },
    { id: 'codeium', name: 'Codeium', category: 'ai-coding', icon: '⚡', description: '免费AI代码补全，Copilot替代', rating: 4.4, featured: false, url: 'https://codeium.com' },
    { id: 'amazon-q', name: 'Amazon Q', category: 'ai-coding', icon: '🟧', description: 'AWS AI助手，云开发利器', rating: 4.2, featured: false, url: 'https://aws.amazon.com/q' },
    { id: 'cody', name: 'Sourcegraph Cody', category: 'ai-coding', icon: '🔬', description: 'AI代码搜索与理解', rating: 4.3, featured: false, url: 'https://sourcegraph.com/cody' },
    { id: 'gemini-code', name: 'Gemini Code Assist', category: 'ai-coding', icon: '✨', description: 'Google AI编程助手', rating: 4.2, featured: false, url: 'https://codeassist.google' },
    { id: 'tome', name: 'Tome', category: 'ai-office', icon: '📖', description: 'AI讲故事式PPT生成', rating: 4.2, featured: false, url: 'https://tome.app' },
    { id: 'xunfei-zhiwen', name: '讯飞智文', category: 'ai-office', icon: '📄', description: '科大讯飞AI文档生成', rating: 4.2, featured: false, url: 'https://zhiwen.xfyun.cn' },
    { id: 'wondershare-ai', name: '万兴AI', category: 'ai-office', icon: '🔧', description: '万兴科技AI文档处理', rating: 4.0, featured: false, url: 'https://ai.wondershare.cn' },
    { id: 'galileo-ai', name: 'Galileo AI', category: 'ai-design', icon: '🌌', description: 'AI UI设计，文字描述生成界面', rating: 4.1, featured: false, url: 'https://www.usegalileo.ai' },
    { id: 'vectorizer', name: 'Vectorizer.ai', category: 'ai-design', icon: '📐', description: 'AI位图转矢量图', rating: 4.4, featured: false, url: 'https://vectorizer.ai' },
    { id: 'adcreative', name: 'AdCreative.ai', category: 'ai-marketing', icon: '📊', description: 'AI广告创意生成，提升转化', rating: 4.2, featured: false, url: 'https://www.adcreative.ai' },
    { id: 'predis', name: 'Predis.ai', category: 'ai-marketing', icon: '📱', description: 'AI社交媒体内容一键生成', rating: 4.0, featured: false, url: 'https://predis.ai' },
    { id: '5118-ai', name: '5118 AI', category: 'ai-writing', icon: '📊', description: 'SEO内容AI生成，站长必备', rating: 4.1, featured: false, url: 'https://www.5118.com' },
    { id: 'gitmind', name: 'GitMind', category: 'ai-writing', icon: '🧠', description: 'AI思维导图，一键生成', rating: 4.2, featured: false, url: 'https://gitmind.cn' },
    { id: 'invideo-ai', name: 'Invideo AI', category: 'ai-video', icon: '🎬', description: '文案一键转视频，自媒体利器', rating: 4.3, featured: false, url: 'https://invideo.io/ai' },
    { id: 'vidu', name: 'Vidu', category: 'ai-video', icon: '🎥', description: '生数科技AI视频，国产新秀', rating: 4.2, featured: false, url: 'https://www.vidu.cn' },
    { id: 'mubert', name: 'Mubert', category: 'ai-audio', icon: '🎧', description: 'AI电子音乐生成，免版权', rating: 4.0, featured: false, url: 'https://mubert.com' },
    { id: 'exa', name: 'Exa AI', category: 'ai-search', icon: '🌐', description: 'AI语义搜索引擎', rating: 4.1, featured: false, url: 'https://exa.ai' },
    { id: 'tabnine-pro', name: 'Tabnine Pro', category: 'ai-coding', icon: '🤖', description: '企业级AI代码补全', rating: 4.1, featured: false, url: 'https://www.tabnine.com' },
    { id: 'boardmix', name: 'Boardmix', category: 'ai-office', icon: '📋', description: 'AI白板协作，一站式办公', rating: 4.1, featured: false, url: 'https://boardmix.cn' },
    { id: 'magician', name: 'Magician', category: 'ai-design', icon: '🪄', description: 'Figma AI插件，设计效率翻倍', rating: 4.0, featured: false, url: 'https://magician.design' },
    { id: 'arcads', name: 'Arcads', category: 'ai-marketing', icon: '🎥', description: 'AI虚拟人广告视频生成', rating: 4.1, featured: false, url: 'https://www.arcads.ai' },
    { id: 'notion-ai-sep', name: 'Notion AI助手', category: 'ai-writing', icon: '📝', description: 'Notion内置AI，工作流无缝', rating: 4.3, featured: false, url: 'https://www.notion.so/product/ai' },
  ];
